...
CUDA_VISIBLE_DEVICES=0 python main.py something RGB \
    ...
    --epochs 30 -b 32 -j 4 --dropout 0.5 \
    --consensus_type temp_att_fusion \
    --result_path Something_results/temp_att_fusion/para_search/r64_ncut64_attb512_sigmoid \
    --resume Something_results/temp_att_fusion/para_search/r64_ncut64_attb512_sigmoid/_rgb_checkpoint.pth.tar
