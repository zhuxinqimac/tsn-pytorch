#CUDA_VISIBLE_DEVICES=1 python score_sens.py \
    ...
    #UCF101_results/conv_lstm_results/sens \
...
CUDA_VISIBLE_DEVICES=1 python score_sens.py \
    ...
    conv_lstm something --lstm_out_type avg \
    --conv_lstm_kernel 3 --lstm_hidden_dims 512 \
    ../TRN-pytorch/video_datasets/something/something_rgb_val_split_1.txt \
    Something_results/conv_lstm_results/sens \
